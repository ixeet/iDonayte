...
public class JDBCDAOAbstract {
    ...
    public Connection getConnection() throws Exception{
       // if(conn==null){
        ...
        DataSource ds = (DataSource)ctx.lookup("java:comp/env/jdbc/idonayte_ds");
    ...
    public Connection getLocalDbConnection() throws Exception{
        ...
        String driver_url="jdbc:mysql://localhost:3306/idonayte?zeroDateTimeBehavior=convertToNull";
        String user="root";
        String pwd="root";
